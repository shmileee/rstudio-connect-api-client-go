...
// RInstallation This defines the information provided by the server about a single installation of R. 
...
func (o RInstallation) MarshalJSON() ([]byte, error) {
...
type NullableRInstallation struct {
	value *RInstallation
	isSet bool
}

func (v NullableRInstallation) Get() *RInstallation {
	return v.value
}

func (v *NullableRInstallation) Set(val *RInstallation) {
	v.value = val
	v.isSet = true
}

func (v NullableRInstallation) IsSet() bool {
	return v.isSet
}

func (v *NullableRInstallation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRInstallation(val *RInstallation) *NullableRInstallation {
	return &NullableRInstallation{value: val, isSet: true}
}

func (v NullableRInstallation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRInstallation) UnmarshalJSON(src []byte) error {
	v.isSet = true

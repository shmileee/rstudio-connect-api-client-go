...
// ContentVisitLogs struct for ContentVisitLogs
type ContentVisitLogs struct {
	Paging *ContentVisitPager `json:"paging,omitempty"`
	// The content visit logs 
	Results *[]ContentVisit `json:"results,omitempty"`
}
...
// SetPaging gets a reference to the given ContentVisitPager and assigns it to the Paging field.
...
// SetResults gets a reference to the given []ContentVisit and assigns it to the Results field.
func (o *ContentVisitLogs) SetResults(v []ContentVisit) {
	o.Results = &v
}

func (o ContentVisitLogs) MarshalJSON() ([]byte, error) {
...
type NullableContentVisitLogs struct {
	value *ContentVisitLogs
	isSet bool
}

func (v NullableContentVisitLogs) Get() *ContentVisitLogs {
	return v.value
}

func (v *NullableContentVisitLogs) Set(val *ContentVisitLogs) {
	v.value = val
	v.isSet = true
}

func (v NullableContentVisitLogs) IsSet() bool {
	return v.isSet
}

func (v *NullableContentVisitLogs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContentVisitLogs(val *ContentVisitLogs) *NullableContentVisitLogs {
	return &NullableContentVisitLogs{value: val, isSet: true}
}

func (v NullableContentVisitLogs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContentVisitLogs) UnmarshalJSON(src []byte) error {
	v.isSet = true

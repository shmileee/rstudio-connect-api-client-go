...
func (r ApiAddGroupMemberRequest) User(user InlineObject6) ApiAddGroupMemberRequest {
	r.user = &user
	return r
}

func (r ApiAddGroupMemberRequest) Execute() (*_nethttp.Response, error) {
 ...
 * @param groupGuid The group's unique identifier 
 * @return ApiAddGroupMemberRequest
 */
func (a *GroupsApiService) AddGroupMember(ctx _context.Context, groupGuid string) ApiAddGroupMemberRequest {
	return ApiAddGroupMemberRequest{
		ApiService: a,
		ctx: ctx,
		groupGuid: groupGuid,
 ...
 */
func (a *GroupsApiService) AddGroupMemberExecute(r ApiAddGroupMemberRequest) (*_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GroupsApiService.AddGroupMember")
	if err != nil {
		return nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/groups/{group_guid}/members"
...
func (r ApiCreateGroupRequest) Group(group InlineObject5) ApiCreateGroupRequest {
	r.group = &group
	return r
}
...
/*
 * CreateGroup Create a group from caller-supplied details (Password, PAM, OAuth2, SAML, Proxied) 
...
type ApiCreateRemoteGroupRequest struct {
	ctx _context.Context
	ApiService *GroupsApiService
	request *InlineObject4
}

func (r ApiCreateRemoteGroupRequest) Request(request InlineObject4) ApiCreateRemoteGroupRequest {
	r.request = &request
	return r
}

func (r ApiCreateRemoteGroupRequest) Execute() (Group, *_nethttp.Response, error) {
	return r.ApiService.CreateRemoteGroupExecute(r)
}

/*
 * CreateRemoteGroup Create a group using details from a remote authentication provider (LDAP) 
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiCreateRemoteGroupRequest
 */
func (a *GroupsApiService) CreateRemoteGroup(ctx _context.Context) ApiCreateRemoteGroupRequest {
	return ApiCreateRemoteGroupRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * @return Group
 */
func (a *GroupsApiService) CreateRemoteGroupExecute(r ApiCreateRemoteGroupRequest) (Group, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GroupsApiService.CreateRemoteGroup")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
 ...
 */
func (a *GroupsApiService) DeleteGroup(ctx _context.Context, guid string) ApiDeleteGroupRequest {
	return ApiDeleteGroupRequest{
		ApiService: a,
		ctx: ctx,
		guid: guid,
...
func (a *GroupsApiService) DeleteGroupExecute(r ApiDeleteGroupRequest) (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/v1/groups/{guid}"
 ...
 */
func (a *GroupsApiService) GetGroup(ctx _context.Context, guid string) ApiGetGroupRequest {
	return ApiGetGroupRequest{
		ApiService: a,
		ctx: ctx,
		guid: guid,
...
func (r ApiGetGroupMembersRequest) Execute() (GroupMembers, *_nethttp.Response, error) {
 ...
 */
func (a *GroupsApiService) GetGroupMembers(ctx _context.Context, groupGuid string) ApiGetGroupMembersRequest {
	return ApiGetGroupMembersRequest{
		ApiService: a,
		ctx: ctx,
		groupGuid: groupGuid,
 ...
 * @return GroupMembers
 */
func (a *GroupsApiService) GetGroupMembersExecute(r ApiGetGroupMembersRequest) (GroupMembers, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiGetGroupsRequest) Prefix(prefix string) ApiGetGroupsRequest {
	r.prefix = &prefix
	return r
}
func (r ApiGetGroupsRequest) PageNumber(pageNumber int32) ApiGetGroupsRequest {
...
func (r ApiGetGroupsRequest) AscOrder(ascOrder bool) ApiGetGroupsRequest {
	r.ascOrder = &ascOrder
	return r
}
...
/*
 * GetGroups List or search for group details
...
func (r ApiRemoveGroupMemberRequest) Execute() (*_nethttp.Response, error) {
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param groupGuid The group's unique identifier 
 * @param userGuid The group member's unique identifier 
 * @return ApiRemoveGroupMemberRequest
 */
func (a *GroupsApiService) RemoveGroupMember(ctx _context.Context, groupGuid string, userGuid string) ApiRemoveGroupMemberRequest {
	return ApiRemoveGroupMemberRequest{
		ApiService: a,
		ctx: ctx,
		groupGuid: groupGuid,
 ...
 * Execute executes the request
 */
func (a *GroupsApiService) RemoveGroupMemberExecute(r ApiRemoveGroupMemberRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodDelete
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GroupsApiService.RemoveGroupMember")
	if err != nil {
		return nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/groups/{group_guid}/members/{user_guid}"
	localVarPath = strings.Replace(localVarPath, "{"+"group_guid"+"}", _neturl.PathEscape(parameterToString(r.groupGuid, "")), -1)
...
type ApiSearchRemoteGroupsRequest struct {
	ctx _context.Context
	ApiService *GroupsApiService
	prefix *string
	limit *int32
...
func (r ApiSearchRemoteGroupsRequest) Prefix(prefix string) ApiSearchRemoteGroupsRequest {
	r.prefix = &prefix
	return r
}
func (r ApiSearchRemoteGroupsRequest) Limit(limit int32) ApiSearchRemoteGroupsRequest {
	r.limit = &limit
	return r
}

func (r ApiSearchRemoteGroupsRequest) Execute() (GroupRemoteSearch, *_nethttp.Response, error) {
	return r.ApiService.SearchRemoteGroupsExecute(r)
}

/*
 * SearchRemoteGroups Search for group details from a remote provider
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiSearchRemoteGroupsRequest
 */
func (a *GroupsApiService) SearchRemoteGroups(ctx _context.Context) ApiSearchRemoteGroupsRequest {
	return ApiSearchRemoteGroupsRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *GroupsApiService) SearchRemoteGroupsExecute(r ApiSearchRemoteGroupsRequest) (GroupRemoteSearch, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  GroupRemoteSearch
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GroupsApiService.SearchRemoteGroups")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/groups/remote"

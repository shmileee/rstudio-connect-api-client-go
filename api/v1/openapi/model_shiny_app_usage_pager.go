...
// ShinyAppUsagePager Paging object that can be used for navigation 
type ShinyAppUsagePager struct {
...
func (o ShinyAppUsagePager) MarshalJSON() ([]byte, error) {
...
type NullableShinyAppUsagePager struct {
	value *ShinyAppUsagePager
	isSet bool
}

func (v NullableShinyAppUsagePager) Get() *ShinyAppUsagePager {
	return v.value
}

func (v *NullableShinyAppUsagePager) Set(val *ShinyAppUsagePager) {
	v.value = val
	v.isSet = true
}

func (v NullableShinyAppUsagePager) IsSet() bool {
	return v.isSet
}

func (v *NullableShinyAppUsagePager) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShinyAppUsagePager(val *ShinyAppUsagePager) *NullableShinyAppUsagePager {
	return &NullableShinyAppUsagePager{value: val, isSet: true}
}

func (v NullableShinyAppUsagePager) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShinyAppUsagePager) UnmarshalJSON(src []byte) error {
	v.isSet = true

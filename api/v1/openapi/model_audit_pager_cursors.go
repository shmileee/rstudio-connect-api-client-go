...
// AuditPagerCursors Cursors that can be used for navigation 
type AuditPagerCursors struct {
...
func (o AuditPagerCursors) MarshalJSON() ([]byte, error) {
...
type NullableAuditPagerCursors struct {
	value *AuditPagerCursors
	isSet bool
}

func (v NullableAuditPagerCursors) Get() *AuditPagerCursors {
	return v.value
}

func (v *NullableAuditPagerCursors) Set(val *AuditPagerCursors) {
	v.value = val
	v.isSet = true
}

func (v NullableAuditPagerCursors) IsSet() bool {
	return v.isSet
}

func (v *NullableAuditPagerCursors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuditPagerCursors(val *AuditPagerCursors) *NullableAuditPagerCursors {
	return &NullableAuditPagerCursors{value: val, isSet: true}
}

func (v NullableAuditPagerCursors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuditPagerCursors) UnmarshalJSON(src []byte) error {
	v.isSet = true

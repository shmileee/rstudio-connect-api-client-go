...
// APIClient manages communication with the RStudio Connect API Reference API v1.0.1
...
type APIClient struct {
	...
	InstrumentationApi *InstrumentationApiService

	RInformationApi *RInformationApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.InstrumentationApi = (*InstrumentationApiService)(&c.common)
	c.RInformationApi = (*RInformationApiService)(&c.common)

...
// ContentUploadBundle Describes the bundle created by a just-completed upload. 
type ContentUploadBundle struct {
...
func (o ContentUploadBundle) MarshalJSON() ([]byte, error) {
...
type NullableContentUploadBundle struct {
	value *ContentUploadBundle
	isSet bool
}

func (v NullableContentUploadBundle) Get() *ContentUploadBundle {
	return v.value
}

func (v *NullableContentUploadBundle) Set(val *ContentUploadBundle) {
	v.value = val
	v.isSet = true
}

func (v NullableContentUploadBundle) IsSet() bool {
	return v.isSet
}

func (v *NullableContentUploadBundle) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContentUploadBundle(val *ContentUploadBundle) *NullableContentUploadBundle {
	return &NullableContentUploadBundle{value: val, isSet: true}
}

func (v NullableContentUploadBundle) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContentUploadBundle) UnmarshalJSON(src []byte) error {
	v.isSet = true

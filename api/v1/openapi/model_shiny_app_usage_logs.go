...
// ShinyAppUsageLogs struct for ShinyAppUsageLogs
type ShinyAppUsageLogs struct {
	Paging *ShinyAppUsagePager `json:"paging,omitempty"`
	// The Shiny application usage logs 
	Results *[]ShinyAppUsage `json:"results,omitempty"`
}
...
// SetPaging gets a reference to the given ShinyAppUsagePager and assigns it to the Paging field.
...
// SetResults gets a reference to the given []ShinyAppUsage and assigns it to the Results field.
func (o *ShinyAppUsageLogs) SetResults(v []ShinyAppUsage) {
	o.Results = &v
}

func (o ShinyAppUsageLogs) MarshalJSON() ([]byte, error) {
...
type NullableShinyAppUsageLogs struct {
	value *ShinyAppUsageLogs
	isSet bool
}

func (v NullableShinyAppUsageLogs) Get() *ShinyAppUsageLogs {
	return v.value
}

func (v *NullableShinyAppUsageLogs) Set(val *ShinyAppUsageLogs) {
	v.value = val
	v.isSet = true
}

func (v NullableShinyAppUsageLogs) IsSet() bool {
	return v.isSet
}

func (v *NullableShinyAppUsageLogs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShinyAppUsageLogs(val *ShinyAppUsageLogs) *NullableShinyAppUsageLogs {
	return &NullableShinyAppUsageLogs{value: val, isSet: true}
}

func (v NullableShinyAppUsageLogs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShinyAppUsageLogs) UnmarshalJSON(src []byte) error {
	v.isSet = true

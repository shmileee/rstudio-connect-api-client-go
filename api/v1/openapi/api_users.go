...
type ApiCreatePullUserRequest struct {
	ctx _context.Context
	ApiService *UsersApiService
	request *InlineObject
}

func (r ApiCreatePullUserRequest) Request(request InlineObject) ApiCreatePullUserRequest {
	r.request = &request
	return r
}

func (r ApiCreatePullUserRequest) Execute() (User, *_nethttp.Response, error) {
	return r.ApiService.CreatePullUserExecute(r)
}

/*
 * CreatePullUser Create a user using details from a remote authentication provider (LDAP, OAuth2) 
 ...
 * @return ApiCreatePullUserRequest
 */
func (a *UsersApiService) CreatePullUser(ctx _context.Context) ApiCreatePullUserRequest {
	return ApiCreatePullUserRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * @return User
 */
func (a *UsersApiService) CreatePullUserExecute(r ApiCreatePullUserRequest) (User, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UsersApiService.CreatePullUser")
	if err != nil {
...
type ApiCreatePushUserRequest struct {
	ctx _context.Context
	ApiService *UsersApiService
	user *InlineObject1
}

func (r ApiCreatePushUserRequest) User(user InlineObject1) ApiCreatePushUserRequest {
	r.user = &user
	return r
}

func (r ApiCreatePushUserRequest) Execute() (User, *_nethttp.Response, error) {
	return r.ApiService.CreatePushUserExecute(r)
}

/*
 * CreatePushUser Create a user from caller-supplied details (SAML, password, PAM, proxied) 
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiCreatePushUserRequest
 */
func (a *UsersApiService) CreatePushUser(ctx _context.Context) ApiCreatePushUserRequest {
	return ApiCreatePushUserRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * @return User
 */
func (a *UsersApiService) CreatePushUserExecute(r ApiCreatePushUserRequest) (User, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UsersApiService.CreatePushUser")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param guid The user's GUID, or unique identifier  Example value = `6f300623-1e0c-48e6-a473-ddf630c0c0c3` using UUID [RFC4122](https://tools.ietf.org/html/rfc4122) format. 
 * @return ApiGetUserRequest
 */
func (a *UsersApiService) GetUser(ctx _context.Context, guid string) ApiGetUserRequest {
	return ApiGetUserRequest{
		ApiService: a,
		ctx: ctx,
		guid: guid,
...
func (a *UsersApiService) GetUserExecute(r ApiGetUserRequest) (User, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/v1/users/{guid}"
...
func (r ApiGetUsersRequest) Prefix(prefix string) ApiGetUsersRequest {
	r.prefix = &prefix
	return r
}
func (r ApiGetUsersRequest) UserRole(userRole string) ApiGetUsersRequest {
	r.userRole = &userRole
	return r
}
func (r ApiGetUsersRequest) AccountStatus(accountStatus string) ApiGetUsersRequest {
	r.accountStatus = &accountStatus
	return r
}
func (r ApiGetUsersRequest) PageNumber(pageNumber int32) ApiGetUsersRequest {
...
func (r ApiGetUsersRequest) AscOrder(ascOrder bool) ApiGetUsersRequest {
	r.ascOrder = &ascOrder
	return r
}
...
/*
 * GetUsers List or search for user details
...
func (a *UsersApiService) GetUsersExecute(r ApiGetUsersRequest) (Users, *_nethttp.Response, error) {
	...
	if r.userRole != nil {
		localVarQueryParams.Add("user_role", parameterToString(*r.userRole, ""))
	}
	if r.accountStatus != nil {
		localVarQueryParams.Add("account_status", parameterToString(*r.accountStatus, ""))
	}
	if r.pageNumber != nil {
...
func (r ApiLockUserRequest) Request(request InlineObject3) ApiLockUserRequest {
	r.request = &request
	return r
}

func (r ApiLockUserRequest) Execute() (*_nethttp.Response, error) {
 ...
 */
func (a *UsersApiService) LockUser(ctx _context.Context, guid string) ApiLockUserRequest {
	return ApiLockUserRequest{
		ApiService: a,
		ctx: ctx,
		guid: guid,
 ...
 * Execute executes the request
 */
func (a *UsersApiService) LockUserExecute(r ApiLockUserRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
type ApiSearchRemoteUsersRequest struct {
	ctx _context.Context
	ApiService *UsersApiService
	prefix *string
	limit *int32
...
func (r ApiSearchRemoteUsersRequest) Prefix(prefix string) ApiSearchRemoteUsersRequest {
	r.prefix = &prefix
	return r
}
func (r ApiSearchRemoteUsersRequest) Limit(limit int32) ApiSearchRemoteUsersRequest {
	r.limit = &limit
	return r
}

func (r ApiSearchRemoteUsersRequest) Execute() (RemoteSearchResults, *_nethttp.Response, error) {
	return r.ApiService.SearchRemoteUsersExecute(r)
}

/*
 * SearchRemoteUsers Search for user details from a remote provider
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiSearchRemoteUsersRequest
 */
func (a *UsersApiService) SearchRemoteUsers(ctx _context.Context) ApiSearchRemoteUsersRequest {
	return ApiSearchRemoteUsersRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *UsersApiService) SearchRemoteUsersExecute(r ApiSearchRemoteUsersRequest) (RemoteSearchResults, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  RemoteSearchResults
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UsersApiService.SearchRemoteUsers")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/users/remote"
...
func (r ApiUpdateUserRequest) User(user InlineObject2) ApiUpdateUserRequest {
	r.user = &user
	return r
}

func (r ApiUpdateUserRequest) Execute() (EditableUser, *_nethttp.Response, error) {
 ...
 */
func (a *UsersApiService) UpdateUser(ctx _context.Context, guid string) ApiUpdateUserRequest {
	return ApiUpdateUserRequest{
		ApiService: a,
		ctx: ctx,
		guid: guid,
 ...
 * @return EditableUser
 */
func (a *UsersApiService) UpdateUserExecute(r ApiUpdateUserRequest) (EditableUser, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  EditableUser
	)

...
// UserWithTicket struct for UserWithTicket
type UserWithTicket struct {
	// The user's username 
...
func (o UserWithTicket) MarshalJSON() ([]byte, error) {
...
type NullableUserWithTicket struct {
	value *UserWithTicket
	isSet bool
}

func (v NullableUserWithTicket) Get() *UserWithTicket {
	return v.value
}

func (v *NullableUserWithTicket) Set(val *UserWithTicket) {
	v.value = val
	v.isSet = true
}

func (v NullableUserWithTicket) IsSet() bool {
	return v.isSet
}

func (v *NullableUserWithTicket) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserWithTicket(val *UserWithTicket) *NullableUserWithTicket {
	return &NullableUserWithTicket{value: val, isSet: true}
}

func (v NullableUserWithTicket) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserWithTicket) UnmarshalJSON(src []byte) error {
	v.isSet = true

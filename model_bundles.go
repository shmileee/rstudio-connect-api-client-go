...
// SetResults gets a reference to the given []Bundle and assigns it to the Results field.
...
func (o Bundles) MarshalJSON() ([]byte, error) {
...
type NullableBundles struct {
	value *Bundles
	isSet bool
}

func (v NullableBundles) Get() *Bundles {
	return v.value
}

func (v *NullableBundles) Set(val *Bundles) {
	v.value = val
	v.isSet = true
}

func (v NullableBundles) IsSet() bool {
	return v.isSet
}

func (v *NullableBundles) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBundles(val *Bundles) *NullableBundles {
	return &NullableBundles{value: val, isSet: true}
}

func (v NullableBundles) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBundles) UnmarshalJSON(src []byte) error {
	v.isSet = true

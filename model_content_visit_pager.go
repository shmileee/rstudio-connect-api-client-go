...
// ContentVisitPager Paging object that can be used for navigation 
type ContentVisitPager struct {
...
func (o ContentVisitPager) MarshalJSON() ([]byte, error) {
...
type NullableContentVisitPager struct {
	value *ContentVisitPager
	isSet bool
}

func (v NullableContentVisitPager) Get() *ContentVisitPager {
	return v.value
}

func (v *NullableContentVisitPager) Set(val *ContentVisitPager) {
	v.value = val
	v.isSet = true
}

func (v NullableContentVisitPager) IsSet() bool {
	return v.isSet
}

func (v *NullableContentVisitPager) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContentVisitPager(val *ContentVisitPager) *NullableContentVisitPager {
	return &NullableContentVisitPager{value: val, isSet: true}
}

func (v NullableContentVisitPager) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContentVisitPager) UnmarshalJSON(src []byte) error {
	v.isSet = true

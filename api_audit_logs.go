...
func (r ApiGetAuditLogsRequest) Previous(previous string) ApiGetAuditLogsRequest {
	r.previous = &previous
	return r
}
func (r ApiGetAuditLogsRequest) Next(next string) ApiGetAuditLogsRequest {
	r.next = &next
	return r
}
func (r ApiGetAuditLogsRequest) AscOrder(ascOrder bool) ApiGetAuditLogsRequest {
	r.ascOrder = &ascOrder
	return r
}

func (r ApiGetAuditLogsRequest) Execute() (AuditLogs, *_nethttp.Response, error) {
 ...
 */
func (a *AuditLogsApiService) GetAuditLogs(ctx _context.Context) ApiGetAuditLogsRequest {
	return ApiGetAuditLogsRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * @return AuditLogs
 */
func (a *AuditLogsApiService) GetAuditLogsExecute(r ApiGetAuditLogsRequest) (AuditLogs, *_nethttp.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/v1/audit_logs"
	...
	if r.ascOrder != nil {
		localVarQueryParams.Add("ascOrder", parameterToString(*r.ascOrder, ""))
	}

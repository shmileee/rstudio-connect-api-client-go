...
// ContentDeploymentInstructions Optionally identifies the target deployment bundle. 
type ContentDeploymentInstructions struct {
...
func NewContentDeploymentInstructions() *ContentDeploymentInstructions {
	this := ContentDeploymentInstructions{}
	return &this
}
...
func (o *ContentDeploymentInstructions) SetBundleIdNil() {
	o.BundleId.Set(nil)
}
...
func (o ContentDeploymentInstructions) MarshalJSON() ([]byte, error) {
...
type NullableContentDeploymentInstructions struct {
	value *ContentDeploymentInstructions
	isSet bool
}

func (v NullableContentDeploymentInstructions) Get() *ContentDeploymentInstructions {
	return v.value
}

func (v *NullableContentDeploymentInstructions) Set(val *ContentDeploymentInstructions) {
	v.value = val
	v.isSet = true
}

func (v NullableContentDeploymentInstructions) IsSet() bool {
	return v.isSet
}

func (v *NullableContentDeploymentInstructions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContentDeploymentInstructions(val *ContentDeploymentInstructions) *NullableContentDeploymentInstructions {
	return &NullableContentDeploymentInstructions{value: val, isSet: true}
}

func (v NullableContentDeploymentInstructions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContentDeploymentInstructions) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// GroupRemoteSearch struct for GroupRemoteSearch
type GroupRemoteSearch struct {
	// The number of groups in the search results 
	Total *int32 `json:"total,omitempty"`
	// The groups list 
	Results *[]GroupWithTicket `json:"results,omitempty"`
...
// SetResults gets a reference to the given []GroupWithTicket and assigns it to the Results field.
...
func (o GroupRemoteSearch) MarshalJSON() ([]byte, error) {
...
type NullableGroupRemoteSearch struct {
	value *GroupRemoteSearch
	isSet bool
}

func (v NullableGroupRemoteSearch) Get() *GroupRemoteSearch {
	return v.value
}

func (v *NullableGroupRemoteSearch) Set(val *GroupRemoteSearch) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupRemoteSearch) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupRemoteSearch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupRemoteSearch(val *GroupRemoteSearch) *NullableGroupRemoteSearch {
	return &NullableGroupRemoteSearch{value: val, isSet: true}
}

func (v NullableGroupRemoteSearch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupRemoteSearch) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// ContentDeploymentTask Identifies the task that can be used to track the progress of a deployment operation. 
type ContentDeploymentTask struct {
...
func (o ContentDeploymentTask) MarshalJSON() ([]byte, error) {
...
type NullableContentDeploymentTask struct {
	value *ContentDeploymentTask
	isSet bool
}

func (v NullableContentDeploymentTask) Get() *ContentDeploymentTask {
	return v.value
}

func (v *NullableContentDeploymentTask) Set(val *ContentDeploymentTask) {
	v.value = val
	v.isSet = true
}

func (v NullableContentDeploymentTask) IsSet() bool {
	return v.isSet
}

func (v *NullableContentDeploymentTask) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContentDeploymentTask(val *ContentDeploymentTask) *NullableContentDeploymentTask {
	return &NullableContentDeploymentTask{value: val, isSet: true}
}

func (v NullableContentDeploymentTask) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContentDeploymentTask) UnmarshalJSON(src []byte) error {
	v.isSet = true

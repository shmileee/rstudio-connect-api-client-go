...
// RInstallations This defines the top-level object that describes the data returned by the server. It contains information about each installation of R that is known. 
type RInstallations struct {
	// The array of information about RStudio Connect's R installations. 
	Installations *[]RInstallation `json:"installations,omitempty"`
}
...
// SetInstallations gets a reference to the given []RInstallation and assigns it to the Installations field.
func (o *RInstallations) SetInstallations(v []RInstallation) {
	o.Installations = &v
}

func (o RInstallations) MarshalJSON() ([]byte, error) {
...
type NullableRInstallations struct {
	value *RInstallations
	isSet bool
}

func (v NullableRInstallations) Get() *RInstallations {
	return v.value
}

func (v *NullableRInstallations) Set(val *RInstallations) {
	v.value = val
	v.isSet = true
}

func (v NullableRInstallations) IsSet() bool {
	return v.isSet
}

func (v *NullableRInstallations) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRInstallations(val *RInstallations) *NullableRInstallations {
	return &NullableRInstallations{value: val, isSet: true}
}

func (v NullableRInstallations) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRInstallations) UnmarshalJSON(src []byte) error {
	v.isSet = true

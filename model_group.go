...
type Group struct {
	...
	OwnerGuid NullableString `json:"owner_guid"`
}
...
// GetOwnerGuid returns the OwnerGuid field value
// If the value is explicit nil, the zero value for string will be returned
func (o *Group) GetOwnerGuid() string {
	if o == nil || o.OwnerGuid.Get() == nil {
		var ret string
		return ret
	}

	return *o.OwnerGuid.Get()
}

// GetOwnerGuidOk returns a tuple with the OwnerGuid field value
// and a boolean to check if the value has been set.
...
func (o *Group) GetOwnerGuidOk() (*string, bool) {
	...
	return o.OwnerGuid.Get(), o.OwnerGuid.IsSet()
}

// SetOwnerGuid sets field value
...
func (o Group) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["owner_guid"] = o.OwnerGuid.Get()
	}

...
// RemoteSearchResults struct for RemoteSearchResults
type RemoteSearchResults struct {
	// The number of users in the search results 
	Total *int32 `json:"total,omitempty"`
	// The users list 
	Results *[]UserWithTicket `json:"results,omitempty"`
...
// SetResults gets a reference to the given []UserWithTicket and assigns it to the Results field.
...
func (o RemoteSearchResults) MarshalJSON() ([]byte, error) {
...
type NullableRemoteSearchResults struct {
	value *RemoteSearchResults
	isSet bool
}

func (v NullableRemoteSearchResults) Get() *RemoteSearchResults {
	return v.value
}

func (v *NullableRemoteSearchResults) Set(val *RemoteSearchResults) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteSearchResults) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteSearchResults) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteSearchResults(val *RemoteSearchResults) *NullableRemoteSearchResults {
	return &NullableRemoteSearchResults{value: val, isSet: true}
}

func (v NullableRemoteSearchResults) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteSearchResults) UnmarshalJSON(src []byte) error {
	v.isSet = true

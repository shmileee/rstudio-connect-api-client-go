...
func (r ApiGetTaskRequest) First(first int32) ApiGetTaskRequest {
	r.first = &first
	return r
}
func (r ApiGetTaskRequest) Wait(wait int32) ApiGetTaskRequest {
	r.wait = &wait
	return r
}
 ...
 */
func (a *TasksApiService) GetTask(ctx _context.Context, id string) ApiGetTaskRequest {
	return ApiGetTaskRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *TasksApiService) GetTaskExecute(r ApiGetTaskRequest) (Task, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/v1/experimental/tasks/{id}"
